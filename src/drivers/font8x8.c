/* 8x8 bitmap font, ASCII 0x20..0x7E (95 glyphs).
 *
 * Bit layout: font8x8[ch - 0x20][row] = uint8_t, bit 0 = leftmost pixel.
 * Hand-crafted — simple and readable, not typographically perfect. Upgrade
 * to a PSF2 font once we have a real font loader (ROADMAP §1). */
...
const uint8_t font8x8[95][8] = {
    ...
    /* 0x2E '.' */ { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0C, 0x00 },
    ...
    /* 0x62 'b' */ { 0x07, 0x06, 0x3E, 0x66, 0x66, 0x66, 0x3B, 0x00 },
    /* 0x63 'c' */ { 0x00, 0x00, 0x1E, 0x33, 0x03, 0x33, 0x1E, 0x00 },
    /* 0x64 'd' */ { 0x38, 0x30, 0x3E, 0x33, 0x33, 0x33, 0x6E, 0x00 },
